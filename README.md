...
5. Go back to the chat preview link. Type in anything you'd like (e.g.: help). Notice that anything other than `agent` or `we are done now` gets replied to automatically.
6. Type in `we are done now`. You will receive a chat ended notification.
